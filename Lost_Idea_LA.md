...
This will be the proposal of my lecture tonight. In what
follows, I want to show how it is possible, even plausible,
to infer from current defenses of liberal education,
including those made at St. John's, that we have lost the
idea of a liberal art, and in a double sense. We have lost
it, first, in *an act* of forgetting; and second, in *a
state* of forgetting caused by the act. In the first sense
of forgetting, we would be in a condition of knowledge, more
or less, about what we have lost. And a case for this will
be made in the first half of my lecture. But in the second
sense of forgetting, we would be in a condition of ignorance
about what we have lost. And a case for this will be made in
the second half of my lecture. One way to speak of the two
senses together, in another formulation of the lecture's
proposal, and by way of concluding this introduction, is to
say that *we* are lost, once the idea of a liberal art is
lost. 
...
Now in one respect, I think, the threat to liberal education
...
external, I think, in a more specific sense.
...
another, then one thing, I think, can be inferred about any
...
This suspicion of content makes it easy, and even seem
necessary, to forget the idea of a liberal art, by making
liberal education a matter of something other than content.
This is made all the more tempting by the perceived threats to
liberal education. For leaving headlines aside, these can
seem to reflect a triumph of content over context, from
college rankings and scorecards at the start, to tests and
grades at the end, making the very meaning of education
a matter of data-driven results, and a choice against
liberal education the answer to a question never asked. Or
perhaps the threat is conceived in economic terms, as if
education were a product with a price in the global
marketplace. Against all this, the first thing we might
think to say is that products are not enough, results are
not enough, answers are not enough, content is not enough.
And this is one way defenses of liberal education have made
it a matter of something other than content. Here are two
examples of the sort of thing said: 

> The maturation of the student---not
information transfer---is the real purpose of colleges and
universities. Of course, information transfer occurs during
this process. One cannot become a master of one’s own
learning without learning something. But information
transfer is a corollary of the maturation process, not its
primary purpose.[^NelsonInfoTransfer]


> If we are to navigate skillfully the turbulent changes of
the twenty-first century, we must educate students not only
to process information effectively, but to think wisely and
well. To my mind, nothing fosters that end better than
a liberal arts education.[^Creighton]
...
extent this depended on skill, was a matter of adaptation
more than application. Any art that deserved the name
'liberal', in that case, would involve a skill more likely
divorced from any subject than wedded to one; which is to
...
since the advent of modern science. (Perhaps allude to this
later.) If the liberal arts could still be said to encompass
a set of subjects, then it would seem better understood as
a diversity than as a totality, in yet another liberation
from content.  

And this is a second way that defenses of liberal
education have made it a matter of something other
than content: by separating its skills from its subjects. The
...
just as "usefulness" has become a ubiquitous word to counter
the opinion, and the traditional conviction, that the
liberal arts are useless.[^Linker] It is more generally the
...
say, is just the difference between being educated and being
indoctrinated.  We so come to a third reason, leaving all
utility aside, we might wonder if a liberal education has
any content, in the belief that a truly liberal education is
again meant to open minds rather than close them. And this
is a third way, then, that defenses of liberal education
make it a matter of something other than content---in light
of one's place in the world, career prospects aside.


In one such form, the skills imparted by a liberal education
become capacities: as Nussbaum [puts
this](http://net.educause.edu/ir/library/pdf/ff0709s.pdf):[^Nussbaum]
...
Then any truly
liberal wouldn involve a skill wedded to openness than to
any subject, the skills imparted by such an eduction would
presumably be in the service of openness, which liberal arts
in such an education would result in openness, and again be
best conceived as skills divorced form subjects. skills
imparted by that education Then the liberal arts would be
what opened minds, in the service of openness, any art that
deserved the name 'liberal' would involve a skill divorced
from a subject indeed be in the service of then  (Put
Nussbaum here. Zakaria. Put Linker in Reason 4)

For suppose our given condition---that is, our
...
And this is a third way that defenses of liberal education
make it a matter of something other than content: by
identifying learning with the act of questioning rather than
...
of a traditional conception of liberal arts, that these were
"the arts of apprehending, understanding, and knowing the
truth."[^Buchanan] What we say instead is self-consciously
Socratic; I give two recent examples of this, one from
a blogpost of Chris Nelson; the other from an address given
...
thought full of content, could more deeply be said to lack
it. For anything written down, we might claim, is simply
doctrine, until a reader puts it into dialogue, and by
questioning it rather than assimilating it. This brings us
to a final reason, then, we might wonder if a liberal
education has any content; and perhaps our best reason to
forget the idea of a liberal art. For suppose we were only
able to learn, truly learn, insofar as we did this for
ourselves. What we learned, in that case, would
seem to be found in the self, or even the soul, rather than
in a set of subjects. And this is the same self that
a liberal education makes free. So the more liberal an
education becomes, we might say, the more that *what* we
learn is a matter of *how* we learn, and *who* we become in
learning it. Which at this college, at least, is to say the
more that any so-called subject is found in a book, which is
found in a reader of that book, who is found in
a conversation about that book, which brings the book to
life, with all it may contain. And this conversation, both
with others and with oneself, might then be said to embody
a liberal education without content: an education in
...
point. It is no surprise, then, that a final way defenses of
liberal education make it a matter of something other than
content is to identify its end with the self, and
a self ready for anything. Here is one example from the same
address by a recent St. John's graduate that I quoted just
above: 
...
I can mention one last example in this vein, as a way to
conclude Part One of my lecture. For in wanting to capture
this kind of student voice on behalf of its education, St.
John's recently performed an experiment for several months, when it
launched its new website. And the experiment was to
describe itself without any mention of the liberal arts,
or even liberal education, as if in the deliberate attempt
to forget the whole idea. 


## Part Two

But this, again, would be to lose the idea knowingly. And it
is time to ask what it might mean to lose this idea
unknowingly. In what sense, then, might *we* be lost, once
the idea of a liberal art is lost? A first reason for
suspecting we *are* lost comes from one thing that allowed
me to write Part One of my lecture. For I could not have
talked about what is typical in current defenses of liberal
education, if they reflected a diversity of views, or
originality of thought. That is: if they reflected what they
claim is learned in a liberal education. But what
distinguishes these defenses most is how they follow a kind
of unquestioned script, and seem reduced to this script once
there is little to say on liberal education's behalf by way
of content. In an ever-changing world, so the script runs,
now more than ever, we need the truly useful skills of
a liberal education. And if you say this when you're a dean,
or a president, or otherwise well-placed, and as if you were
the first to say it rather than merely the latest, then
you're likely to be heard as a defender of liberal
education; and if you're someone else, saying something
else, by way of question or challenge or counter, you're
just as likely to be ignored.[^McClay 2] The closing of ranks on this
even put St. John's in the awkward position, during the time
it dropped any reference to the liberal arts, of seeming to
dismiss those who would question the script while embracing
those who could polish the script, as if its education were
Sophistic rather than Socratic.[^McClay] Perhaps this could
all be excused if the script were working; but again, there
is no evidence that it has. And I'll be giving more reasons
presently for why it shouldn't. But even without
these reasons, it is hard, I think, to explain
a defense of liberal education that seems not to be
a product of liberal education, save by something closer to
self-ignorance than to self-knowledge.   

[^McClay 2]: I owe a clarified sense of this script to an article by
B.D. McClay, "With Friends Like These." <http://iasc-culture.org/THR/channels/THR/2015/06/with-friends-like-these/>
[^McClay]: [Here's one 
example](http://spectator.org/articles/60752/defense-liberal-arts)
of what the college dismissed: 
...
at least getting paid. Or, for that matter, in kindergarten.

But again, there *are* other reasons to worry that *we*
might be lost once the idea of liberal is lost. And one way
to frame them, for the rest of my discussion, is to ask this
question: what else might we have forgotten, in forgetting
the idea of a liberal art? One answer to this question,
which we might keep in mind for the rest of my discussion,
is that we have forgotten how to defend liberal education in
a way that can be taken seriously, rather than just
rhetorically. Or to put this in terms of my account in Part
One, we have forgotten how to show that liberal education
provides an answer to the question of what it means to be
educated, even for those who give a different answer. We
have forgotten how to show that something is lost in
a choice against liberal education, whatever might be
gained; and that the answer we give in such a choice, even
if it turns out right, risks being wrong. But I can put this
answer one final way, which will be my suggestion by the end
of Part Two: Once we forget the idea of a liberal art, we
forget what it means to be free. 

To begin to see all this, I want to return to the basic set
of skills, again separated from subjects, that it is claimed
a liberal education imparts. There is no doubt that learning
how to learn, along with how to read, write, speak, and
think, are useful skills; and one might even grant their
necessity for a life lived in freedom. But it is hard to see
how these skills belong to a liberal education rather than
to any education. And the more indispensable these skills
sound, the harder it is to conceive them as liberal rather
than remedial. Shouldn't we already know how to learn, and
read, write, speak, and think, before we go to college?
...
think creatively. But are we we then to believe that you
...
that made sense of losing the idea of a liberal art as this
was traditionally conceived. Or perhaps nothing is meant
against another form of education when it is said what you
can learn in a liberal education. But if so, then what again
...
for example, Chris Nelson writes: "St. John’s College is the
right fit for someone who is seeking a special sort of
education---an education in the arts of freedom, an
education in how to make learning and life their own." But
in what sense, exactly, does this distinguish a St. John's
education from any education, or even from human experience
as such? For this would seem to be experience, rather than
innocence, or mere endurance, through the kind of learning,
and living, that is necessarily one's own. Or suppose we
follow the St. John's graduate I quoted in the first part of
my lecture, and claim that St. John's will teach you
...
on science rather than superstition to reach its results.
And making references back to Socrates, as if the
Enlightenment never happened, won't be enough to distinguish
St. John's in particular, or liberal education more
generally, on the matter of intellectual courage. 

It would easy, of course, to distinguish a liberal education
from any education, if it could be said just what is
learned, or read, or written, or spoken, or thought, to
locate these skills in a liberal education alone. But to say
this much is just what defenses of liberal education refuse
to say, in wanting to claim the skills in question can be
applied to anything. And this suggests that once we forget
the idea of a liberal art, we forget how to distinguish
a liberal education from any education, or even from what
happens in human life regardless of education. 

But in forgetting this much, it seems we also then forget
how to show that something is lost in a choice against
liberal education, since there is nothing to distinguish
a liberal education from any education. And since we are put
in this predicament by making liberal education a matter of
something other than content, we so risk making any *choice*
about education a matter of content, which makes a choice
against liberal education not just possible, but likely, at
for those who become serious about their education, and want
it to have content. I can use computer programming again as
an example of what I mean. *Bloomberg Businessweek* recently
published [a 38,000 word
essay](http://www.bloomberg.com/graphics/2015-paul-ford-what-is-code/)
entitled "What is Code?." And if you read this essay, it is
hard to shake the impression that it makes more sense of
a liberal education than anything published in its defense.
This is not just because the writer of the essay knows how
to write, and proves it over the course of 38,000 words. It
is also because of what he is writing about, which starts to
sound like a true liberal art by the time he is through:
a skill, programming, wedded to a subject, code, that
encompasses a kind of whole in contemporary life. ---And
indeed the kind of whole in contemporary life---the essay
again appeared in *Businessweek*---that defenses of liberal
education will claim it best prepares its graduates for.
A serious high school student who read this essay might be
forgiven, then, if she concluded that a real college
education could be had by pursuing a programming degree, and
that making learning one's own means learning one thing
well. 

But this is just one example, and hypothetical at that, of
a more general, actual, and recognized problem. Consider the
way that defenders of liberal education are compelled to
speak against the penchant in education for testing and
ranking and training and specializing, declaring again that
content is not enough, against the seeming triumph of
content over context. They know this risks the impression
that a liberal education is an education for dilettantes,
providing an escape from being challenged or judged or
driven or dedicated. But what can be said to counter this
impression, if in a liberal education, these virtues are
matters of context rather than content? Which is to say,
matters about which nothing more can be said, but
only shown---where you see such students for yourself? Or
even be such a student yourself?---as one noted defender of
liberal education, Andrew Delbanco, [puts
...
a matter of context rather than content. For if the point
of any defense is *to persuade* people to experience liberal
education for themselves, then how can there be a defense
that depends on such an experience to be persuasive?  

Defenses of education do attempt to address this, but one
could say it is by doubling down on context rather than
shifting to content, in the attempt not simply to say what
a liberal education is, but to show it. The most visible
sign of this is the images that you can find increasingly in
liberal arts college brochures and on websites, which being
images rather than text, can can better capture the
experience of a liberal education, when explanations of it
not enough. St. John's has its own striking history of this.
For not so long ago it packaged its education in a brown
paper wrapper---as if the education not only had content,
but the kind of content that couldn't be seen from outside.
Even the first video it made of itself, back in 1954, was
mostly staged, retaining at least that much separation from
the ongoing world. But it is just this separation that is
now deemed better erased than preserved; and communication
efforts at the college seem aimed at giving the impression
that what separates the college from the outside world is
merely a window, albeit a window that frames the
better-looking among us. This strategy also makes a kind of
sense, if we describe it as the attempt to allay any
suspicions that St. John's is less like a college and more
like a cult. Or to put the sense of this strategy more
generally: to defend liberal education by locating the place
of liberal education *in* the world rather than apart from
it. 



Mention notion that St. John's was a cult, and problems of 
initiation, but gerater point. What seems to have been forgotten here is the original point
of setting a liberal education part. Education was once regarded
as a serious enough thing, but also fragile enough thing, to
be set apart from the ongoing world rather than anchored there. And the
freedom involved was at the end of the education, in a mode
of self-transformation rather than self-affirmation. (use above):
We have replaced this package, ign is found
in the images The defense of liberal education on the
grounds of its usefulness rather than uselessness, as if in
a freedom for the world.  is perhaps and its ends are
anchored in the world. one of anchoring liberal education in
the world, against the traditional notion that it stood
apart from the world, and even aloof from the world and even
aloof. 
to make the experience of a liberal education show and locating
the place of liberal education firmly *in* the world rather
than at all apart from it. This way of putting it, in fact,
shows us the sense in which the defenses of liberal
education that I discussed in Part One, in which it is by
making liberal education And indeed this might be said of
the entire line of defense that I described in Part One:
that the defense makes liberal education a matter of
something other than content, by making it a matter of
context. And indeed the essential gesture in defenses of
liberal education, once content is given up, might be
described as contextualizing, where the place of liberal
education is located firmly in the world rather than at all
apart from it. The mantra of "usefulness" in defenses is
perhaps the most important sign of this contextualizing, 
Sense of value of freedom, and nature of freedom, goes hand in hand with
its fragility. 
And if we can be
suspicious of content insofar as it binds us rather than
frees us, then it seems we can even more suspicious of
context, which arguably binds us by its very nature. And I think
it is on this very point that we can begin to find something
deeply misconceived in 

What liberal education frees us for has to survive the self if the self can
die for it, but this would suggest it is indeed a matter of subjects rather
than the self.
sk how
we are freed by content rather than bound to it, he same
suspicion that we might be bound to content rather than
freed by it, might be directed all the more to matters of
context, which are essentially bounded. it also defines such
defenses in a counter-triumph of context over content. against any impression that it stands apart from the
world.  or even aloof  attempt to anchor liberal education
makes sense to call defenses of liberal education then one
might characterize the defense as a triumph of context over
content, one way of characterizing these defenses, in light
of the second problem with context, is to make context
triumph over content. Which is to say: to present a liberal
education, increasingly, as if it were possible to
experience it for oneself. Or to put this still another way,
to root it in the world rather than separate it from the
world. , 

alike this: 
And if these
are matters of context rather than content, then the
impression of dilettantism can only be corrected, in effect,
by an invitation to campus. And what if the invitation is
declined?  But we
can recognize that this rejoinder, too, is not enough, and
even see that saying what more is needed, if this is
context, escapes being specified, in just the way it escapes
being captured in a data-driven result. Yet this can reduce
our defense of liberal education to something like
inarticulate pointing. And what if no one else turns around?
Or to put the problem with context more concretely, we can
speak with eloquence 

Described this as a liberation from content, but it can look more
like a flight from content.

 
that is, a defense of what truly binds us by way of context,
over what we merely suspect may bind us by way of content.Only so much that can be said about a liberal education; the
essence of it can only be shown. You have to see it for yourself.
Contextualization is like specification.


(Put after discussion of context.) More generally it seems as
if this entire line of defense risks falling apart as soon
as you take it seriously and not just rhetorically. 

Or perhaps this is not the implication (use this idea to transition
into how not having content risks not giving a real answer, but a fake one.)

The ever-changing world like an unexamined opinion.

Note: to be non-elistist is to include the slave-boy, not Meno.

In an ever-changing world, now more than ever, a liberal
arts education is needed, with its truly useful skills.

The more seriously you take its claims, the more empty they
seem.

Also, conversation may bring books to life, but the books give
the conversation a point.

End by confessing the title of this lecture is really The Lost Idea
of a Liberal Art, Part One
